...
import { useGetMembers } from "@/features/members/api/use-get-workspace";
...
export const WorkspaceIdClient = () => {
    ...
    return (
        <div className="h-full flex flex-col space-y-4 m-2">
        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-muted rounded-lg p-4">
                ...
                <ul className="flex flex-col gap-y-4">
                    {data.map((task) => (
                        <li key={task.$id}>
                            <Link href={`/workspaces/tasks/${workspaceId}/${task.$id}`}>
                    ...
                    <li className="texts-sm text-muted-foreground text-center hidden first-of-type:block">
                        No tasks found
                    </li>
                </ul>
                <Button variant="muted" className="mt-4 w-full" asChild>
                    <Link href={`/workspaces/tasks/${workspaceId}`}>
                        Show All
                    </Link>
                </Button>
            </div>
        ...
        <div className="flex flex-col gap-y-4 col-span-1">
            <div className="bg-white border rounded-lg p-4">
                ...
                <ul className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    {data.map((project) => (
                        <li key={project.$id}>
                            <Link href={`/workspaces/projects/${workspaceId}/${project.$id}`}>
                                <Card className="shadow-none rounded-lg hover:opacity-75 transition">
            ...
            <div className="bg-white border rounded-lg p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Button variant="secondary" size="icon" asChild>
                        <Link href={`/workspaces/members/${workspaceId}`}>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {data.map((member) => (
                        <li key={member.$id}>
                            <Card className="shadow-none rounded-lg overflow-hidden h-[160px]">
